...
const Header = () => (
  <header className="fixed left-1/2 top-5 z-50 w-[min(92vw,800px)] -translate-x-1/2">
    <div
      className="relative rounded-full backdrop-blur-md p-1.5"
      style={{
        background: "rgba(10,9,8,0.7)",
        boxShadow:
          "0 0 0 1px rgba(255,255,255,0.07), 0 20px 60px rgba(0,0,0,0.55), 0 1px 0 rgba(255,255,255,0.05) inset",
      }}
    >
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent 5%, color-mix(in oklab, var(--rr-accent), transparent 60%) 35%, rgba(255,255,255,0.08) 65%, transparent 95%)",
        }}
      />
